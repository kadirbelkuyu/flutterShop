...
class HomeSliderWidget1 extends StatefulWidget {
  final List<Slide> slides;

  @override
  _HomeSliderWidget1State createState() => _HomeSliderWidget1State();

  HomeSliderWidget1({Key key, this.slides}) : super(key: key);
}

class _HomeSliderWidget1State extends State<HomeSliderWidget1> {
  int _current = 0;
