...
class CategoriesCarouselItemWidget extends StatelessWidget {
  ...
  double margintop;
  Category category;
  CategoriesCarouselItemWidget({Key key,this.margintop, this.marginLeft, this.category}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          Hero(
            tag: category.id,
            child: Container(
              margin: EdgeInsetsDirectional.only(start: this.marginLeft, top: this.margintop, end: 20),
              width: 82,
              height: 80,
